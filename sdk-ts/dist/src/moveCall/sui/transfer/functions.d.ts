...
export declare function publicReceive(txb: TransactionBlock, typeArg: Type, args: PublicReceiveArgs): import("@mysten/sui.js/transactions").TransactionResult;
...
export declare function receivingObjectId(txb: TransactionBlock, typeArg: Type, receiving: ObjectArg): import("@mysten/sui.js/transactions").TransactionResult;
